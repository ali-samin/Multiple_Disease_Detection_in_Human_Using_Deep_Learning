...
if ($total != 0) {
	?>
	<h2 align="center">Brain Tumor Patient Details</h2>
	<center>
		<table border="1">
			<tr>
                <th>ID</th>
...
<script>
    function redirectToVerifiedPatients() {
        ...
        // Redirect to the verified_brain_patients.php page
        window.location.href = 'verified_brain_patients.php';
    }
    ...
    $(document).ready(function () {
        ...
        $('input[type=radio]').change(function () {
            ...
            $.ajax({
                type: 'POST',
                url: 'update_brain_verification.php',
                data: {
                    action: action,
                    patientId: patientId
                },
